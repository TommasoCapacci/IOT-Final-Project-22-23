...
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
static void RadioRouteC$radioSendTask$runTask(void );
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
static 
#line 74
message_t * 
...
static void RadioRouteC$Timer0$stop(void );
# 104 "/opt/tinyos-main-2.1.2/tos/interfaces/SplitControl.nc"
...
# 67 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
static error_t RadioRouteC$radioSendTask$postTask(void );
# 64 "RadioRouteC.nc"
enum RadioRouteC$__nesc_unnamed4333 {
#line 64
  RadioRouteC$radioSendTask = 3U
};
#line 64
typedef int RadioRouteC$__nesc_sillytask_radioSendTask[RadioRouteC$radioSendTask];
#line 28
message_t *RadioRouteC$packetsPool[1000][PACKET_POOL_SIZE];
uint16_t RadioRouteC$addressesPool[1000][PACKET_POOL_SIZE];
uint8_t RadioRouteC$head[1000];
uint8_t RadioRouteC$tail[1000];


uint16_t RadioRouteC$requestAddress[1000];
message_t *RadioRouteC$request[1000];


Node *RadioRouteC$connections[1000];
Node *RadioRouteC$subscriptions[1000][3];


uint16_t RadioRouteC$counter[1000];




static void RadioRouteC$generate_send(uint16_t address, uint16_t message_type, uint16_t id, uint16_t topic, uint16_t payload, bool retFlag);
static inline void RadioRouteC$handleRetransmission(uint16_t address, message_t *message);

static inline void RadioRouteC$printPacketDebug(radio_route_msg_t *payload);

static bool RadioRouteC$searchID(Node *list, uint8_t node_id);
static Node *RadioRouteC$addNode(Node *list, uint8_t node_id);
static void RadioRouteC$printList(Node *list);

static inline void RadioRouteC$handleCONNECT(radio_route_msg_t *payload);
static inline void RadioRouteC$handleCONNACK(radio_route_msg_t *payload);
static inline void RadioRouteC$handleSUB(radio_route_msg_t *payload);
static inline void RadioRouteC$handleSUBACK(radio_route_msg_t *payload);
static inline void RadioRouteC$handlePUBLISH(radio_route_msg_t *payload);
...
static inline void RadioRouteC$handlePUBLISH(radio_route_msg_t *payload);
#line 215
static inline void RadioRouteC$radioSendTask$runTask(void );
...
#line 198
{
  ...
  if (TOS_NODE_ID == 1) {
      temp = RadioRouteC$subscriptions[sim_node()][__nesc_ntoh_uint16(payload->topic.nxdata)];
      while (temp != (void *)0) {
          if (temp->id != __nesc_ntoh_uint16(payload->id.nxdata)) {
              RadioRouteC$generate_send(temp->id, PUBLISH, __nesc_ntoh_uint16(payload->id.nxdata), __nesc_ntoh_uint16(payload->topic.nxdata), __nesc_ntoh_uint16(payload->payload.nxdata), 0);
              temp = temp->next;
            }
        }
    }
...
inline static void RadioRouteC$Timer0$stop(void ){
#line 78
...
#line 187
{
  if (RadioRouteC$request[sim_node()] != (void *)0) {
      RadioRouteC$Timer0$stop();
      free(RadioRouteC$request[sim_node()]);
      RadioRouteC$request[sim_node()] = (void *)0;


      RadioRouteC$Timer1$startPeriodic(PUB_INTERVAL);
    }
}
...
#line 177
{
  if (RadioRouteC$searchID(RadioRouteC$connections[sim_node()], __nesc_ntoh_uint16(payload->id.nxdata))) {
      RadioRouteC$subscriptions[sim_node()][__nesc_ntoh_uint16(payload->topic.nxdata)] = RadioRouteC$addNode(RadioRouteC$subscriptions[sim_node()][__nesc_ntoh_uint16(payload->topic.nxdata)], __nesc_ntoh_uint16(payload->id.nxdata));
      sim_log_debug(154U, "Data", "Printing list of subscriptions on topic %d:\n", __nesc_ntoh_uint16(payload->topic.nxdata));
      RadioRouteC$printList(RadioRouteC$subscriptions[sim_node()][__nesc_ntoh_uint16(payload->topic.nxdata)]);

      RadioRouteC$generate_send(__nesc_ntoh_uint16(payload->id.nxdata), SUBACK, __nesc_ntoh_uint16(payload->id.nxdata), __nesc_ntoh_uint16(payload->topic.nxdata), 0, 0);
    }
}
...
#line 173
      RadioRouteC$generate_send(1, SUB, TOS_NODE_ID, __nesc_ntoh_uint16(payload->topic.nxdata), 0, 1);
    }
}
...
#line 151
{
  RadioRouteC$connections[sim_node()] = RadioRouteC$addNode(RadioRouteC$connections[sim_node()], __nesc_ntoh_uint16(payload->id.nxdata));
  sim_log_debug(153U, "Data", "Printing list of active connections:\n");
  RadioRouteC$printList(RadioRouteC$connections[sim_node()]);

  RadioRouteC$generate_send(__nesc_ntoh_uint16(payload->id.nxdata), CONNACK, __nesc_ntoh_uint16(payload->id.nxdata), 0, 0, 0);
}
...
#line 274
{
  ...
  sim_log_debug(162U, "Radio_recv", "Received packet at time %s:\n", sim_time_string());
  RadioRouteC$printPacketDebug(packet);

  switch (__nesc_ntoh_uint16(packet->message_type.nxdata)) {
      case CONNECT: 
        RadioRouteC$handleCONNECT(packet);
      break;
      case CONNACK: 
        RadioRouteC$handleCONNACK(packet);
      break;
      case SUB: 
        RadioRouteC$handleSUB(packet);
      break;
      case SUBACK: 
        RadioRouteC$handleSUBACK(packet);
      break;
      case PUBLISH: 
        RadioRouteC$handlePUBLISH(packet);
      break;
    }
...
#line 91
{
  ...
  RadioRouteC$request[sim_node()] = (message_t *)malloc(sizeof(message_t ));
  memcpy(RadioRouteC$request[sim_node()], message, sizeof(message_t ));
  RadioRouteC$requestAddress[sim_node()] = address;
  RadioRouteC$Timer0$startOneShot(ACK_TIMEOUT);
}
...
{
  if (err == SUCCESS) {
      sim_log_debug(157U, "Radio", "Radio on on node %d!\n", TOS_NODE_ID);
      if (TOS_NODE_ID != 1) {

        RadioRouteC$generate_send(1, CONNECT, TOS_NODE_ID, 0, 0, 1);
        }
    }
  else 
#line 236
...
# 67 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
inline static error_t RadioRouteC$radioSendTask$postTask(void ){
#line 67
  unsigned char __nesc_result;
#line 67

#line 67
  __nesc_result = SimSchedulerBasicP$TaskBasic$postTask(RadioRouteC$radioSendTask);
#line 67
...
#line 67
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0xb7514908, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0xb7514908, addr, msg, len);
#line 80
...
#line 215
{
  if (RadioRouteC$AMSend$send(RadioRouteC$addressesPool[sim_node()][RadioRouteC$tail[sim_node()]], RadioRouteC$packetsPool[sim_node()][RadioRouteC$tail[sim_node()]], sizeof(radio_route_msg_t )) == SUCCESS) {
    sim_log_debug(155U, "Radio_send", "Sending packet to %d at time %s:\n", RadioRouteC$addressesPool[sim_node()][RadioRouteC$tail[sim_node()]], sim_time_string());
    }
  else {
#line 219
    RadioRouteC$radioSendTask$postTask();
    }
}
...
# 100 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0xb7517ea8, message_t * msg, error_t error){
#line 100
  switch (arg_0xb7517ea8) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0xb7517ea8, msg, error);
#line 100
      break;
#line 100
    }
...
#line 75
      break;
#line 75
    case RadioRouteC$radioSendTask:
#line 75
      RadioRouteC$radioSendTask$runTask();
#line 75
      break;
#line 75
...
#line 246
{
  ...
  radio_route_msg_t *packet = (radio_route_msg_t *)RadioRouteC$Packet$getPayload(RadioRouteC$request[sim_node()], sizeof(radio_route_msg_t ));

  sim_log_error(160U, "Timer", "Request was not acknowledged in time. Resending.\n");
  RadioRouteC$generate_send(RadioRouteC$requestAddress[sim_node()], __nesc_ntoh_uint16(packet->message_type.nxdata), __nesc_ntoh_uint16(packet->id.nxdata), __nesc_ntoh_uint16(packet->topic.nxdata), __nesc_ntoh_uint16(packet->payload.nxdata), 1);
}
...
#line 270
  ...
  RadioRouteC$generate_send(1, PUBLISH, TOS_NODE_ID, topic, RadioRouteC$counter[sim_node()], 0);
}
...
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0xb739c3a8){
#line 83
  switch (arg_0xb739c3a8) {
#line 83
    case 0U:
#line 83
...
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0xb739c3a8);
#line 83
      break;
#line 83
    }
...
#line 125
{
  ...
  if (RadioRouteC$searchID(list, node_id)) {
    return list;
    }
  newNode->id = node_id;
  newNode->next = list;
...
#line 69
{
  ...
  radio_route_msg_t *packet = (radio_route_msg_t *)RadioRouteC$Packet$getPayload(message, sizeof(radio_route_msg_t ));
...
#line 78
    {
      RadioRouteC$packetsPool[sim_node()][RadioRouteC$head[sim_node()]] = message;
      RadioRouteC$addressesPool[sim_node()][RadioRouteC$head[sim_node()]] = address;
      RadioRouteC$head[sim_node()] = (RadioRouteC$head[sim_node()] + 1) % PACKET_POOL_SIZE;
    }
#line 82
    __nesc_atomic_end(__nesc_atomic); }

  if (retFlag) {
    RadioRouteC$handleRetransmission(address, message);
    }
  RadioRouteC$radioSendTask$postTask();
}
...
#line 311
    {
      if (bufPtr == RadioRouteC$packetsPool[sim_node()][RadioRouteC$tail[sim_node()]]) {
          free(RadioRouteC$packetsPool[sim_node()][RadioRouteC$tail[sim_node()]]);
          RadioRouteC$tail[sim_node()] = (RadioRouteC$tail[sim_node()] + 1) % PACKET_POOL_SIZE;
        }

      if (RadioRouteC$head[sim_node()] != RadioRouteC$tail[sim_node()]) {
        RadioRouteC$radioSendTask$postTask();
        }
    }
#line 320
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  /* Module RadioRouteC */
  if (!strcmp(varname, "RadioRouteC$packetsPool"))
  {
    *addr = (uintptr_t)&RadioRouteC$packetsPool[__nesc_mote];
    *size = sizeof(RadioRouteC$packetsPool[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "RadioRouteC$addressesPool"))
  {
    *addr = (uintptr_t)&RadioRouteC$addressesPool[__nesc_mote];
    *size = sizeof(RadioRouteC$addressesPool[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "RadioRouteC$head"))
  {
    *addr = (uintptr_t)&RadioRouteC$head[__nesc_mote];
    *size = sizeof(RadioRouteC$head[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "RadioRouteC$tail"))
  {
    *addr = (uintptr_t)&RadioRouteC$tail[__nesc_mote];
    *size = sizeof(RadioRouteC$tail[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "RadioRouteC$requestAddress"))
  {
    *addr = (uintptr_t)&RadioRouteC$requestAddress[__nesc_mote];
    *size = sizeof(RadioRouteC$requestAddress[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "RadioRouteC$request"))
  {
    *addr = (uintptr_t)&RadioRouteC$request[__nesc_mote];
    *size = sizeof(RadioRouteC$request[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "RadioRouteC$connections"))
  {
    *addr = (uintptr_t)&RadioRouteC$connections[__nesc_mote];
    *size = sizeof(RadioRouteC$connections[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "RadioRouteC$subscriptions"))
  {
    *addr = (uintptr_t)&RadioRouteC$subscriptions[__nesc_mote];
    *size = sizeof(RadioRouteC$subscriptions[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  /* Module RadioRouteC */
  memset((void *)&RadioRouteC$packetsPool[__nesc_mote], 0, sizeof RadioRouteC$packetsPool[__nesc_mote]);
  memset((void *)&RadioRouteC$addressesPool[__nesc_mote], 0, sizeof RadioRouteC$addressesPool[__nesc_mote]);
  RadioRouteC$head[__nesc_mote] = 0;
  RadioRouteC$tail[__nesc_mote] = 0;
  RadioRouteC$requestAddress[__nesc_mote] = 0;
  memset((void *)&RadioRouteC$request[__nesc_mote], 0, sizeof RadioRouteC$request[__nesc_mote]);
  RadioRouteC$connections[__nesc_mote] = (void *)0;
  memcpy((void *)&RadioRouteC$subscriptions[__nesc_mote], (void *)&(struct Node *[3]){ (void *)0, (void *)0, (void *)0 }, sizeof RadioRouteC$subscriptions[__nesc_mote]);
  RadioRouteC$counter[__nesc_mote] = 0;
