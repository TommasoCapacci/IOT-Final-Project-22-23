...
# 61 "/opt/tinyos-main-2.1.2/tos/interfaces/Leds.nc"
static void RadioRouteC$Leds$led0Off(void );
...
#line 77
static void RadioRouteC$Leds$led1Off(void );
#line 94
static void RadioRouteC$Leds$led2Off(void );
# 32 "RadioRouteC.nc"
...
bool RadioRouteC$openReq[1000];
message_t RadioRouteC$packetDataToSend[1000];
uint16_t RadioRouteC$addressToSend[1000];

Route RadioRouteC$table[1000][7];

uint16_t RadioRouteC$personcode[1000][8];
uint16_t RadioRouteC$ind[1000];




static inline bool RadioRouteC$destinationReachable(uint16_t address);
...
{
  LedsP$Led2$toggle();
  sim_log_debug(193U, "LedsC", "LEDS: Led""2"" %s.\n", LedsP$Led2$get() ? "off" : "on");
#line 116
  ;
}
...
{
  LedsP$Led1$toggle();
  sim_log_debug(190U, "LedsC", "LEDS: Led""1"" %s.\n", LedsP$Led1$get() ? "off" : "on");
#line 101
  ;
}
...
{
  LedsP$Led0$toggle();
  sim_log_debug(187U, "LedsC", "LEDS: Led""0"" %s.\n", LedsP$Led0$get() ? "off" : "on");
#line 86
  ;
}
...
#line 63
{
  ...
  return RadioRouteC$table[sim_node()][address - 1].next_hop != 0;
}
...
#line 267
{
  ...
  radio_route_msg_t *sdm = (radio_route_msg_t *)RadioRouteC$Packet$getPayload(bufPtr, sizeof(radio_route_msg_t ));

  if (len != sizeof(radio_route_msg_t ) || sdm == (void *)0) {
      return bufPtr;
    }
  else {
      ...
      switch (__nesc_ntoh_uint8(rcm->type.nxdata)) {
          case ROUTE_REQUEST: 

            if (!RadioRouteC$destinationReachable(__nesc_ntoh_uint8(rcm->node_requested.nxdata)) && __nesc_ntoh_uint8(rcm->node_requested.nxdata) != TOS_NODE_ID) {
                RadioRouteC$generate_send(AM_BROADCAST_ADDR, bufPtr, ROUTE_REQUEST);
              }
            else {

              if (__nesc_ntoh_uint8(rcm->node_requested.nxdata) == TOS_NODE_ID) {
                  __nesc_hton_uint8(sdm->type.nxdata, ROUTE_REPLY);
                  __nesc_hton_uint8(sdm->sender.nxdata, TOS_NODE_ID);
                  __nesc_hton_uint8(sdm->node_requested.nxdata, TOS_NODE_ID);
                  __nesc_hton_uint8(sdm->cost.nxdata, 1);
                  RadioRouteC$generate_send(AM_BROADCAST_ADDR, bufPtr, ROUTE_REPLY);
                }
              else {

                if (RadioRouteC$destinationReachable(__nesc_ntoh_uint8(rcm->node_requested.nxdata))) {
                    __nesc_hton_uint8(sdm->type.nxdata, ROUTE_REPLY);
                    __nesc_hton_uint8(sdm->sender.nxdata, TOS_NODE_ID);
                    __nesc_hton_uint8(sdm->node_requested.nxdata, __nesc_ntoh_uint8(rcm->node_requested.nxdata));
                    __nesc_hton_uint8(sdm->cost.nxdata, RadioRouteC$table[sim_node()][__nesc_ntoh_uint8(rcm->node_requested.nxdata) - 1].cost + 1);
                    RadioRouteC$generate_send(AM_BROADCAST_ADDR, bufPtr, ROUTE_REPLY);
                  }
                }
              }
#line 310
          ...
          case ROUTE_REPLY: 
            ...
            if (__nesc_ntoh_uint8(rcm->node_requested.nxdata) == TOS_NODE_ID) {
              ...
              if (!RadioRouteC$destinationReachable(__nesc_ntoh_uint8(rcm->node_requested.nxdata)) || __nesc_ntoh_uint8(rcm->cost.nxdata) < RadioRouteC$table[sim_node()][__nesc_ntoh_uint8(rcm->node_requested.nxdata) - 1].cost) {
                  RadioRouteC$table[sim_node()][__nesc_ntoh_uint8(rcm->node_requested.nxdata) - 1].next_hop = __nesc_ntoh_uint8(rcm->sender.nxdata);
                  RadioRouteC$table[sim_node()][__nesc_ntoh_uint8(rcm->node_requested.nxdata) - 1].cost = __nesc_ntoh_uint8(rcm->cost.nxdata);


                  if (RadioRouteC$openReq[sim_node()] == TRUE && RadioRouteC$destinationReachable(RadioRouteC$addressToSend[sim_node()])) {
                      sim_log_debug(175U, "data", "Node %d can finally send data %s\n", TOS_NODE_ID, sim_time_string());
                      RadioRouteC$openReq[sim_node()] = FALSE;
                      RadioRouteC$generate_send(RadioRouteC$addressToSend[sim_node()], &RadioRouteC$packetDataToSend[sim_node()], DATA_MESSAGE);
                    }
                  else {
                      __nesc_hton_uint8(sdm->sender.nxdata, TOS_NODE_ID);
                      __nesc_hton_uint8(sdm->cost.nxdata, __nesc_ntoh_uint8(rcm->cost.nxdata) + 1);
                      RadioRouteC$generate_send(AM_BROADCAST_ADDR, bufPtr, ROUTE_REPLY);
                    }
                }
              }
          ...
          case DATA_MESSAGE: 
            if (__nesc_ntoh_uint8(rcm->destination.nxdata) != TOS_NODE_ID) {
              RadioRouteC$generate_send(__nesc_ntoh_uint8(rcm->destination.nxdata), bufPtr, DATA_MESSAGE);
              }
            else {
#line 344
              sim_log_debug(176U, "data", "Data message received from node %d with value %d\n", __nesc_ntoh_uint8(rcm->sender.nxdata), __nesc_ntoh_uint8(rcm->value.nxdata));
              }
#line 345
          break;
        }
      ...
      switch (RadioRouteC$personcode[sim_node()][RadioRouteC$ind[sim_node()]] % 3) {
          case 0: 
      ...
      sim_log_debug(177U, "leds", "Leds status: %u%u%u\n", RadioRouteC$Leds$get() & 0x1, (RadioRouteC$Leds$get() >> 1) & 0x1, (RadioRouteC$Leds$get() >> 2) & 0x1);
      if (TOS_NODE_ID == 6) {
        sim_log_debug(178U, "leds_6", "Leds status: %u%u%u\n", RadioRouteC$Leds$get() & 0x1, (RadioRouteC$Leds$get() >> 1) & 0x1, (RadioRouteC$Leds$get() >> 2) & 0x1);
        }


      RadioRouteC$ind[sim_node()]++;
      if (RadioRouteC$ind[sim_node()] >= 8) {
        RadioRouteC$ind[sim_node()] = 0;
        }
      return bufPtr;
    }
}
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0xb765e298, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0xb765e298) {
#line 78
    case 10:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0xb765e298, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0xb765e930, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0xb765e930, msg, payload, len);
#line 78
...
{
  if (err == SUCCESS) {
      sim_log_debug(170U, "radio", "Radio on on node %d!\n", TOS_NODE_ID);


      if (TOS_NODE_ID == 1) {
          sim_log_debug(171U, "timer", "Starting Timer1 on node %d at %s\n", TOS_NODE_ID, sim_time_string());
          RadioRouteC$Timer1$startOneShot(5000);
        }
    }
  else {
      sim_log_error(172U, "radio", "Radio failed to start, retrying...\n");
...
#line 235
{
  sim_log_debug(173U, "boot", "Radio stopped!\n");
}
...
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0xb766d8b0, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0xb766d8b0, msg, error);
#line 110
}
#line 110
...
# 100 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0xb74c86a8, message_t * msg, error_t error){
#line 100
  switch (arg_0xb74c86a8) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0xb74c86a8, msg, error);
#line 100
      break;
#line 100
    }
...
#line 70
{
  ...
  switch (__nesc_ntoh_uint8(payload->type.nxdata)) {
      case DATA_MESSAGE: 
        sim_log_debug_clear(148U, "radio_pack", "\t Type: %u \n", __nesc_ntoh_uint8(payload->type.nxdata));
      sim_log_debug_clear(149U, "radio_pack", "\t Sender: %u \n", __nesc_ntoh_uint8(payload->sender.nxdata));
      sim_log_debug_clear(150U, "radio_pack", "\t Value: %u \n", __nesc_ntoh_uint8(payload->value.nxdata));
      sim_log_debug_clear(151U, "radio_pack", "\t Address: %u \n", __nesc_ntoh_uint8(payload->destination.nxdata));
      break;
      case ROUTE_REQUEST: 
        sim_log_debug_clear(152U, "radio_pack", "\t Type: %u \n", __nesc_ntoh_uint8(payload->type.nxdata));
      sim_log_debug_clear(153U, "radio_pack", "\t Node requested: %u \n", __nesc_ntoh_uint8(payload->node_requested.nxdata));
      break;
      case ROUTE_REPLY: 
        sim_log_debug_clear(154U, "radio_pack", "\t Type: %u \n", __nesc_ntoh_uint8(payload->type.nxdata));
      sim_log_debug_clear(155U, "radio_pack", "\t Sender: %u \n", __nesc_ntoh_uint8(payload->sender.nxdata));
      sim_log_debug_clear(156U, "radio_pack", "\t Node requested: %u \n", __nesc_ntoh_uint8(payload->node_requested.nxdata));
      sim_log_debug_clear(157U, "radio_pack", "\t Cost: %u \n", __nesc_ntoh_uint8(payload->cost.nxdata));
      break;
    }
}

# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0xb74c70a0, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0xb74c70a0, addr, msg, len);
#line 80
...
#line 128
{
  ...
  uint16_t next_hop;
  radio_route_msg_t *msg = (radio_route_msg_t *)RadioRouteC$Packet$getPayload(packet, sizeof(radio_route_msg_t ));
...
#line 134
  ...
  if (RadioRouteC$locked[sim_node()]) {
      sim_log_debug(158U, "data", "Node %d found locked while sending data at time %s\n", TOS_NODE_ID, sim_time_string());
      return FALSE;
    }
  else {

      if (address != AM_BROADCAST_ADDR) {
          if (!RadioRouteC$destinationReachable(address)) {
              if (!RadioRouteC$route_req_sent[sim_node()]) {
                  sim_log_debug(159U, "data", "No route for actual address -> sending route request\n");

                  RadioRouteC$packetDataToSend[sim_node()] = *packet;
                  RadioRouteC$addressToSend[sim_node()] = address;
                  RadioRouteC$openReq[sim_node()] = TRUE;

                  sim_log_debug(160U, "data", "Delaying sending of packet with:\n");
                  sim_log_debug_clear(161U, "radio_pack", "\t Type: %u \n", __nesc_ntoh_uint8(msg->type.nxdata));
                  sim_log_debug_clear(162U, "radio_pack", "\t Sender: %u \n", __nesc_ntoh_uint8(msg->sender.nxdata));
                  sim_log_debug_clear(163U, "radio_pack", "\t Value: %u \n", __nesc_ntoh_uint8(msg->value.nxdata));
                  sim_log_debug_clear(164U, "radio_pack", "\t Address: %u \n", RadioRouteC$addressToSend[sim_node()]);

                  __nesc_hton_uint8(msg->type.nxdata, ROUTE_REQUEST);
                  __nesc_hton_uint8(msg->node_requested.nxdata, address);
                  ...
                  sim_log_debug(165U, "data", "No route for actual address but request already sent\n");
                  return FALSE;
                }
            }
          else {
              sim_log_debug(166U, "data", "Route found -> sending data packet\n");
              next_hop = RadioRouteC$table[sim_node()][address - 1].next_hop;
            }
        }
      else {
        next_hop = address;
  ...
  if (RadioRouteC$AMSend$send(next_hop, packet, sizeof(radio_route_msg_t )) == SUCCESS) {
      RadioRouteC$locked[sim_node()] = TRUE;

      sim_log_debug(167U, "radio_send", "Sending packet to next hop %d at time %s:\n", next_hop, sim_time_string());
      RadioRouteC$printPacketDebug(msg);
...
#line 247
{
  ...
  radio_route_msg_t *msg = (radio_route_msg_t *)RadioRouteC$Packet$getPayload(&RadioRouteC$queued_packet[sim_node()], sizeof(radio_route_msg_t ));
...
#line 252
  ...
  __nesc_hton_uint8(msg->type.nxdata, DATA_MESSAGE);
  __nesc_hton_uint8(msg->sender.nxdata, TOS_NODE_ID);
  __nesc_hton_uint8(msg->destination.nxdata, 7);
  __nesc_hton_uint8(msg->value.nxdata, 5);

  RadioRouteC$queue_addr[sim_node()] = __nesc_ntoh_uint8(msg->destination.nxdata);

  sim_log_debug(174U, "data", "Node %d sending first data packet at time %s\n", TOS_NODE_ID, sim_time_string());
  RadioRouteC$generate_send(RadioRouteC$queue_addr[sim_node()], &RadioRouteC$queued_packet[sim_node()], DATA_MESSAGE);
}
...
#line 57
  {
    sim_log_debug(184U, "Init", "LEDS: initialized.\n");
...
inline static void RadioRouteC$Leds$led2Off(void ){
#line 94
  LedsP$Leds$led2Off();
#line 94
}
...
inline static void RadioRouteC$Leds$led1Off(void ){
#line 77
  LedsP$Leds$led1Off();
#line 77
}
...
# 61 "/opt/tinyos-main-2.1.2/tos/interfaces/Leds.nc"
inline static void RadioRouteC$Leds$led0Off(void ){
#line 61
  LedsP$Leds$led0Off();
#line 61
}
...
#line 199
  for (; i < 7; i++) {
      RadioRouteC$table[sim_node()][i].next_hop = 0;
      RadioRouteC$table[sim_node()][i].cost = 0;
    }

  sim_log_debug(168U, "boot", "Application booted.\n");


  RadioRouteC$Leds$led0Off();
  RadioRouteC$Leds$led1Off();
  RadioRouteC$Leds$led2Off();


  if (TOS_NODE_ID == 6) {
    sim_log_debug(169U, "leds_6", "Leds status: %u%u%u\n", RadioRouteC$Leds$get() & 0x1, (RadioRouteC$Leds$get() >> 1) & 0x1, (RadioRouteC$Leds$get() >> 2) & 0x1);
    }
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  if (!strcmp(varname, "RadioRouteC$openReq"))
  {
    *addr = (uintptr_t)&RadioRouteC$openReq[__nesc_mote];
    *size = sizeof(RadioRouteC$openReq[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "RadioRouteC$packetDataToSend"))
  {
    *addr = (uintptr_t)&RadioRouteC$packetDataToSend[__nesc_mote];
    *size = sizeof(RadioRouteC$packetDataToSend[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "RadioRouteC$addressToSend"))
  {
    *addr = (uintptr_t)&RadioRouteC$addressToSend[__nesc_mote];
    *size = sizeof(RadioRouteC$addressToSend[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "RadioRouteC$table"))
  {
    *addr = (uintptr_t)&RadioRouteC$table[__nesc_mote];
    *size = sizeof(RadioRouteC$table[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "RadioRouteC$personcode"))
  {
    *addr = (uintptr_t)&RadioRouteC$personcode[__nesc_mote];
    *size = sizeof(RadioRouteC$personcode[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "RadioRouteC$ind"))
  {
    *addr = (uintptr_t)&RadioRouteC$ind[__nesc_mote];
    *size = sizeof(RadioRouteC$ind[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  RadioRouteC$openReq[__nesc_mote] = FALSE;
  memset((void *)&RadioRouteC$packetDataToSend[__nesc_mote], 0, sizeof RadioRouteC$packetDataToSend[__nesc_mote]);
  memset((void *)&RadioRouteC$addressToSend[__nesc_mote], 0, sizeof RadioRouteC$addressToSend[__nesc_mote]);
  memset((void *)&RadioRouteC$table[__nesc_mote], 0, sizeof RadioRouteC$table[__nesc_mote]);
  memcpy((void *)&RadioRouteC$personcode[__nesc_mote], (void *)&(unsigned short [8]){ 1, 0, 6, 8, 7, 7, 4, 7 }, sizeof RadioRouteC$personcode[__nesc_mote]);
  RadioRouteC$ind[__nesc_mote] = 0;
